    ...
    <PageShell>
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="text-sm text-[color:var(--color-muted)]">
          Showing <span className="font-bold text-ink">{filtered.length}</span> of {protocols.length} protocols
        </div>
      ...
      {filtered.length === 0 ? (
        <Card><CardContent className="py-16 text-center">
          ...
          <div className="font-bold mb-1">No protocols match</div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border text-left">
                    <th className="py-3 px-5 font-bold text-ink">ID</th>
                    <th className="py-3 px-5 font-bold text-ink">Title</th>
                    <th className="py-3 px-5 font-bold text-ink">Sector</th>
                    <th className="py-3 px-5 font-bold text-ink">Status</th>
                    <th className="py-3 px-5 font-bold text-ink">Version</th>
                    <th className="py-3 px-5 font-bold text-ink">Issued</th>
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <tr className="border-b border-border last:border-0 hover:bg-surface cursor-pointer transition-colors duration-200">
